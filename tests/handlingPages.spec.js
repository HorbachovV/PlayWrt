...
// npx playwright test handlingPages.spec.js --project=chromium --headed --debug


test.skip('Handle pages', async () => {
...
test('Handle Multiple pages', async () => {
    ...
    await page1.locator('//anormalize-space()="OrangeHRM, Inc"').click();
